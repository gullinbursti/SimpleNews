<?php
	...
	class Articles {
		...
		function getMostLikedArticles() {			
			...
			$query = 'SELECT * FROM `tblArticles` WHERE `active` = "Y" AND `type_id` >= 2;';
			$article_result = mysql_query($query);
