...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td valign="top"><form id="frmMostLiked" name="frmMostLiked" method="post" action="main.php?a=1"><table cellpadding="0" cellspacing="0" border="0"><?php echo ("\n");
					$cnt = 0;
			...
			<tr>
				<td valign="top"><form id="frmTop10" name="frmTop10" method="post" action="main.php?a=2"><table cellpadding="0" cellspacing="0" border="0"><?php echo ("\n");
					$cnt = 0;
