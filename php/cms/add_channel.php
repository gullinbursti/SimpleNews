	...
	<body>
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<td><form id="frmAdd" name="frmAdd" method="post" action="./add_channel.php"><table cellspacing="0" cellpadding="0" border="0">
					...
					<tr><td colspan="2"><input type="submit" id="btnAdd" name="btnAdd" value="Add Channel" /></td></tr>
				</form></table></td>
			</tr>
		</table>
	</body>
