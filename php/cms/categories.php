	...
	<head>
		...
		<script type="text/javascript">
			function remove(cat_id) {
				var prompt = confirm("Delete this category?");
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<td><table cellspacing="0" cellpadding="0" border="0">
					...
					<tr><td colspan="2"><input type="button" id="btnAdd" name="btnAdd" value="Add Category" onclick="location.href='./add_category.php'" /></td></tr>
				</table></td>
			</tr>
		</table>
	</body>
