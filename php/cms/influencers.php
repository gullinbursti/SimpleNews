...
$query = 'SELECT * FROM `tblInfluencers` ORDER BY `added` DESC;';
	...
	<head>
		...
		<script type="text/javascript">
			function edit(twitter_id) {
				location.href = "./edit_influencer.php?id=" + twitter_id;
			}
			...
			function remove(twitter_id) {
				...
				if (prompt)
					location.href = "./delete_influencer.php?id=" + twitter_id;
			}
		</script>
	</head>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<td><table cellspacing="0" cellpadding="0" border="0">
					<tr><td><input type="button" id="btnAdd" name="btnAdd" value="Add Influencer" onclick="location.href='./add_influencer.php'"></td></tr>
