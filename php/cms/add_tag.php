...
if (isset($_POST['txtName'])) {
	...
	$query = 'INSERT INTO `tblTags` (';
	$query .= '`id`, `title`, `info`, `active`, `added`, `modified`) ';
	$query .= 'VALUES (NULL, "'. $tag_name .'", "'. $tag_info .'", "'. $tag_active .'", NOW(), CURRENT_TIMESTAMP);';
	...
	<body>
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<td><form id="frmAdd" name="frmAdd" method="post" action="./add_tag.php"><table cellspacing="0" cellpadding="0" border="0">
					...
					<tr><td colspan="2"><input type="submit" id="btnAdd" name="btnAdd" value="Add Tag" /></td></tr>
				</form></table></td>
			</tr>
		</table>
	</body>
