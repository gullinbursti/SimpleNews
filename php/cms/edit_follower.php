...
$query = 'SELECT * FROM `tblFollowers` WHERE `id` = "'. $_GET['id'] .'";';
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<td><form id="frmEdit" name="frmEdit" method="post" action="./edit_follower.php?a=0&id=<?php echo ($row[0]); ?>"><table cellspacing="0" cellpadding="0" border="0">
					...
					<tr><td><input type="button" id="btnCancel" name="btnCancel" value="Cancel" onclick="history.back();" /></td><td><input type="button" id="btnEdit" name="btnEdit" value="Edit Follower" onclick="edit();" /></td></tr>
				</form></table></td>
			</tr>
		</table>
	</body>
