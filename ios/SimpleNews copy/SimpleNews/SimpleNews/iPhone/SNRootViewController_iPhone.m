...
//			[_holderView addSubview:_discoveryListView.view];
			...
			_topicTimelineView = [[SNTopicTimelineView_iPhone alloc] initWithTopicVO:(SNTopicVO *)[_topicsList objectAtIndex:0]];
...
-(void)_composeSourceArticle:(NSNotification *)notification {
	SNComposerViewController_iPhone *composerViewController = [[SNComposerViewController_iPhone alloc] initWithArticle:_articleVO];
	UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:composerViewController];
	[navigationController setNavigationBarHidden:YES];
	[self.navigationController presentModalViewController:navigationController animated:YES];
}
