...
-(id)initWithFrame:(CGRect)frame {
	if ((self = [super initWithFrame:frame])) {
		...
		facebookButton.titleLabel.font = [[SNAppDelegate snHelveticaNeueFontBold] fontWithSize:14.0];
		...
		facebookButton.titleLabel.shadowColor = [UIColor blackColor];
		facebookButton.titleLabel.shadowOffset = CGSizeMake(0.0, -1.0);
		...
		twitterButton.titleLabel.shadowColor = [UIColor blackColor];
		twitterButton.titleLabel.shadowOffset = CGSizeMake(0.0, -1.0);
		...
		emailButton.titleLabel.shadowColor = [UIColor blackColor];
		emailButton.titleLabel.shadowOffset = CGSizeMake(0.0, -1.0);
