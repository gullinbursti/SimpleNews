//
//  SNFriendProfileViewController.m
//  SimpleNews
//
...
#import "SNFriendProfileViewController.h"
...
@implementation SNFriendProfileViewController
...
//	[self.view addSubview:shareButton];
	...
	_notificationsRequest = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@", kServerPath, kUsersAPI]]];
...
-(void)_goTwitterProfile {
	SNWebPageViewController *webPageViewController = [[SNWebPageViewController alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://twitter.com/#!/%@", _vo.handle]] title:[NSString stringWithFormat:@"@%@", _vo.handle]];
...
-(void)_goLikedArticles {
	[self.navigationController pushViewController:[[SNProfileArticlesViewController alloc] initWithUserID:_vo.userID asType:6] animated:YES];
}

-(void)_goCommentedArticles {
	[self.navigationController pushViewController:[[SNProfileArticlesViewController alloc] initWithUserID:_vo.userID asType:2] animated:YES];
}

-(void)_goSharedArticles {
	[self.navigationController pushViewController:[[SNProfileArticlesViewController alloc] initWithUserID:_vo.userID asType:5] animated:YES];
}
