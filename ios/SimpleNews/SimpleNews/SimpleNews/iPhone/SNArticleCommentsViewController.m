//
//  SNArticleCommentsViewController.m
//  SimpleNews
//
...
@implementation SNArticleCommentsViewController
...
-(void)loadView {
	...
	SNHeaderView *headerView = [[SNHeaderView alloc] initWithTitle:@"Comments"];
	...
	for (SNCommentVO *vo in _vo.comments) {
		...
		CGSize txtSize = [vo.content sizeWithFont:[[SNAppDelegate snHelveticaNeueFontMedium] fontWithSize:11] constrainedToSize:CGSizeMake(250.0, CGFLOAT_MAX) lineBreakMode:UILineBreakModeClip];		
		SNArticleCommentView *commentView = [[SNArticleCommentView alloc] initWithFrame:CGRectMake(0.0, _commentOffset, _scrollView.frame.size.width, kItemHeight + txtSize.height) commentVO:vo];
...
-(void)requestFinished:(ASIHTTPRequest *)request { 
	...
	CGSize txtSize = [vo.content sizeWithFont:[[SNAppDelegate snHelveticaNeueFontMedium] fontWithSize:11] constrainedToSize:CGSizeMake(250.0, CGFLOAT_MAX) lineBreakMode:UILineBreakModeClip];
	for (SNArticleCommentView *commentView in _commentViews) {
	...
	SNArticleCommentView *commentView = [[SNArticleCommentView alloc] initWithFrame:CGRectMake(0.0, 0.0, _scrollView.frame.size.width, kItemHeight + txtSize.height) commentVO:vo];
