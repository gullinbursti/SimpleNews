//
//  SNDiscoveryListViewController.m
//  SimpleNews
//
...
#import "SNDiscoveryItemViewController.h"

#import "MBLResourceLoader.h"

@interface SNDiscoveryListViewController() <MBLResourceObserverProtocol>
...
@implementation SNDiscoveryListViewController
...
- (void)viewDidLoad
{
	...
	SNHeaderView *headerView = [[SNHeaderView alloc] initWithTitle:self.title];
...
{
	SNDiscoveryItemViewController *itemViewController = [[SNDiscoveryItemViewController alloc] init];
