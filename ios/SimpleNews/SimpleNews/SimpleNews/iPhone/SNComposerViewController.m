...
@implementation SNComposerViewController
...
- (void)loadView
{
	...
	_headerView = [[SNHeaderView alloc] initWithTitle:@"Composer"];
...
- (void)viewDidAppear:(BOOL)animated {
	...
	if (_isFirstAppearance) {
		...
		if (_isArticleSource) {
			_composeEditorView = [[SNComposeEditorView alloc] initWithFrame:CGRectOffset(self.view.frame, 0.0, 45.0) withArticle:_vo];
...
-(void) imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
	...
	_composeEditorView = [[SNComposeEditorView alloc] initWithFrame:CGRectOffset(self.view.frame, 0.0, 45.0) withImage:image];
	[self.view addSubview:_composeEditorView];
}
