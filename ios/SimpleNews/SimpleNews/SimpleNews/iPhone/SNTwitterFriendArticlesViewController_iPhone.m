//
//  SNTwitterFriendArticlesViewController_iPhone.m
//  SimpleNews
//
...
@implementation SNTwitterFriendArticlesViewController_iPhone
...
-(id)initAsArticlesRead:(SNTwitterUserVO *)vo {
	if ((self = [super init])) {
		...
		[_articlesRequest setPostValue:[NSString stringWithFormat:@"%d", _vo.userID] forKey:@"userID"];
