//
//  SNProfileArticlesViewController.m
//  SimpleNews
//
...
@implementation SNProfileArticlesViewController
...
-(void)loadView {
	...
	SNHeaderView *headerView = [[SNHeaderView alloc] initWithTitle:_headerTitle];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	SNProfileArticleViewCell *cell = [tableView dequeueReusableCellWithIdentifier:[SNProfileArticleViewCell cellReuseIdentifier]];
		
	if (cell == nil)
		cell = [[SNProfileArticleViewCell alloc] init];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[self.navigationController pushViewController:[[SNWebPageViewController alloc] initWithURL:[NSURL URLWithString:vo.article_url] title:vo.title] animated:YES];
}
