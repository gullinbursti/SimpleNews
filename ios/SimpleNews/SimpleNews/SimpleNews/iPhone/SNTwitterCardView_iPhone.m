...
@implementation SNTwitterCardView_iPhone
...
-(id)initWithFrame:(CGRect)frame {
	if ((self = [super initWithFrame:frame])) {
		...
		bgImgView.image = [UIImage imageNamed:@"twitterAd.png"];
		...
		[connectButton setBackgroundImage:[[UIImage imageNamed:@"twitterButton_nonActive.png"] stretchableImageWithLeftCapWidth:0.0 topCapHeight:0.0] forState:UIControlStateNormal];
		[connectButton setBackgroundImage:[[UIImage imageNamed:@"twitterButton_Active.png"] stretchableImageWithLeftCapWidth:0.0 topCapHeight:0.0] forState:UIControlStateHighlighted];
		...
		[connectButton setTitle:@"Connect to Twitter" forState:UIControlStateNormal];
